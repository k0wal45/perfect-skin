  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2 items-start w-full">
        <input 
          type="checkbox" name="accpet" id="accpet" className='block' required/>
      ...
      <button type='submit' className='p-4 px-8 bg-primary rounded-md text-white font-bold grid mt-4 place-items-center text-xl w-full transition-all duration-300
      ...
      <input 
        type="checkbox" name="validate" id="validate" className='scale-0 w-0 h-0' />
