        ...
        <div className="relative rounded-3xl bg-neutral-100 p-8 lg:p-16 overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="relative z-10 max-w-2xl text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-4 py-1 rounded-full bg-white/80 text-neutral-600 mb-4">
              ...
              <Typography variant="sectionSubtitle" className="!tracking-wider">
                BEZPIECZNA I TRWAŁA GŁADKOŚĆ
              </Typography>
            </div>
            <Typography variant="h2" className="mb-4 leading-tight">
              Umów się na depilacji laserową
            </Typography>
            <Typography variant="body" className="max-w-xl mx-auto lg:mx-0">
              Zaplanujemy indywidualny harmonogram zabiegów laserowych
              dopasowany do Twojego fototypu. Zyskaj idealną gładkość w
              komfortowej atmosferze i bez podrażnień.
            </Typography>
          </div>
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-center gap-4 w-full lg:w-auto">
            <Button
              asChild
              size="lg"
              className="w-full sm:w-auto shadow-lg rounded-full px-8"
            >
              <a href={BOOKSY_URL} target="_blank" rel="noopener noreferrer">
                Umów wizytę online
                <ArrowRight className="h-4 w-4 text-nowrap" />
              </a>
            </Button>
            <Button
              asChild
              variant="ghost"
              size="lg"
              className="w-full sm:w-auto bg-white text-neutral-900 shadow-sm border border-neutral-200 rounded-full px-6 hover:bg-neutral-50"
            >
              <a href="tel:+48790216665">
                <Phone className="h-4 w-4 text-nowrap" />
                +48 790 216 665
              </a>
            </Button>
          </div>
